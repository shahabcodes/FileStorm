package com.shahaabapps.filestorm.ui.theme
...
fun FileStormTheme(content: @Composable () -> Unit) {
    val appearance = com.shahaabapps.filestorm.data.Prefs.appearance
    val systemDark = isSystemInDarkTheme()
    val dark = appearance.isDark(systemDark)

    val accentChoice = com.shahaabapps.filestorm.data.Prefs.accent
    ...
    val useThemeAccent = accentChoice == com.shahaabapps.filestorm.data.Accent.BLUE &&
        com.shahaabapps.filestorm.data.Prefs.palette !=
        com.shahaabapps.filestorm.data.ThemePalette.DEFAULT
    val plainAccent = Color(if (dark) accentChoice.dark else accentChoice.light)

    val fs = when (com.shahaabapps.filestorm.data.Prefs.palette) {
        com.shahaabapps.filestorm.data.ThemePalette.BLOSSOM -> if (dark) FsColors(
        ...
        com.shahaabapps.filestorm.data.ThemePalette.SAKURA -> if (dark) FsColors(
